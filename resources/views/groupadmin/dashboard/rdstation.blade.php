                         ...
                         <!--new box start-->
                          <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <div class="tab-content" id="myTabContent">
                             ...
                             <div class="tab-pane   fade show active" id="customized" role="tabpanel" aria-labelledby="customized-tab">
                                    ...
                                    <div class="row padflex hideall">
                                        ...
                                        <div class="row padflex hideall">
                                             <div class="col-md-6" id="messagE_box">
                                            <label style="font-weight: 600;font-size: 18px;margin-bottom: 5px;">{{__('group.rdstation_token')}} </label>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                             ...
                             <li class="nav-item" role="presentation">
                                <button class="nav-link" id="customized-tab" data-toggle="tab" data-target="#customized" type="button" role="tab" aria-controls="customized" aria-selected="false">{{__('group.ul_rd_station')}}</button>
                              </li>
                            </ul>
                            ...
                            <div class="tab-content" id="myTabContent">
                             ...
                             <div class="tab-pane   fade show active" id="customized" role="tabpanel" aria-labelledby="customized-tab">
                                ...
                                <input type="hidden" name="setting" value="rdstation">
                                     ...
                                     <div class="row padflex hideall">
                                          <div class="col-md-6" id="messagE_box">
                                            ...
                                            <textarea rows="4" class="form-control sms_body_web" id="reply-input-main" name="message">{{$data->message}}</textarea>
                                        </div>
