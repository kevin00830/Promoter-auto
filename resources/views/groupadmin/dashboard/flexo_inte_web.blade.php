                    ...
                    <div class="container-fluid">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                              ...
                              <li class="nav-item" role="web"> 
                                <button class="nav-link active" id="web-tab" data-toggle="tab" data-target="#web" type="button" role="tab" aria-controls="web" aria-selected="false">{{__('group.webwithbuttons')}}</button>
                              </li>
                             <!--<li class="nav-item" role="presentation">-->
                            ...
                            <div class="tab-pane fade show active" id="web" role="tabpanel" aria-labelledby="web-tab">
                                <div class="form-box">
                                    ...
                                    <div class="row padflex">
                                        <div class="col-md-6">
                                            <label style="font-weight: 600;font-size: 18px;margin-bottom: 15px;">1. {{__('group.keywords')}}</label>
                                    ...
                                    <div class="row padflex">
                                        <div class="col-md-6">
                                            <label style="font-weight: 600;font-size: 18px;margin-bottom: 15px;">2. {{__('group.message')}} </label>
                                            <textarea rows="4" class="form-control sms_body_web" id="reply-input" name="msg"></textarea>
                                        </div>
                                        <div class="col-md-6" style="display:grid">
                                            <input type="file" name="flow_img" class="btn btn-primary btnstyl- "/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row padflex">
                                     ...
                                     <div class="row padflex">
                                        <div class="col-md-12">
                                            <label style="font-weight: 600;font-size: 18px;margin-bottom: 15px;">4. {{__('group.button_blocks')}} </label>
                                        </div>
                                        <div class="col-md-12 btninputpaddings">
                                            <div class="col-md-1" >
                                                <label class="form-check-label">  {{__('group.block_no')}}</label>
                                                <input type="text" name="blockno[]" class="form-control" value="1" disabled>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-check-label"> {{__('group.block_tittle')}}</label>
                                        ...
                                        <div class="col-md-12 btninputpaddings">
                                            <div class="col-md-2" >
                                                <label class="form-check-label"> {{__('group.button1')}}</label>
                                                <input type="text" name="btnname[0][]" class="form-control">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-check-label"> {{__('group.button2')}}</label>
                                                <input type="text" name="btnname[0][]" class="form-control">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-check-label"> {{__('group.button3')}}</label>
                                                <input type="text" name="btnname[0][]" class="form-control">
                                            </div>
                                        </div>
                                ...
                                <div class="row padflex">
                                        <div class="col-md-6">
                                             <div class="form-group">
                                                <label style="font-weight: 600;font-size: 18px;margin-bottom: 15px;" for="flow">{{__('group.select_flow')}}:</label>
                             ...
                             <div class="tab-pane fade" id="customized" role="tabpanel" aria-labelledby="customized-tab">
                                ...
                                <tr>
                                    ...
                                    <td>{{$flow->reply}}</td>
                                    <td>
                                        <button class="btn btn-primary btn-sm edit-main-btn" data-id="{{$flow->id}}">Edit</button>
                                    </td>
                                     <td>
                                        <button class="btn btn-danger btn-sm delete-btn" data-id="{{$flow->id}}">Delete</button>
                                    </td>
